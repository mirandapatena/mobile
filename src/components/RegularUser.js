...
if(!this.incidentAlertSettled){
 ...
 isRespondingResponder = data2.isRespondingResponder;
 isRespondingResponderShown = data2.isRespondingResponderShown;
 ...
 if (data2) {
   ...
   isRespondingVolunteer = data2.isRespondingVolunteer;
   isArrivedVolunteer = data2.isArrivedVolunteer;
   isArrivedVolunteerShown = data2.isArrivedVolunteerShown;
   timeVolunteerArrived = data2.timeVolunteerArrived;
 ...
 app.database().ref("/incidents").push({
   ...
   requestResponders:'', //array for additional requestResponders
 ...
 app.database().ref(`mobileUsers/Regular User/${user.uid}`);
